...
const TableRow = (props) => {
    ...
    const deactivateVehcile = props.deactivateVehcile
    const setCurrentData = props.setCurrentData
    
    //setting up state values
    const [landedState, setLandedState] = useState(props.landedState)
    const [currLocation, setLocation] = useState(props.initialCraftData.currLocation)
    const [deltaV, setDeltaV] = useState(props.initialCraftData.deltaV)
